...
public class GoalManager
{
    ...
    {
        if (_score >= 5000) return "Master of Habits";
        if (_score >= 2500) return "Dedicated Achiever";
        if (_score >= 1000) return "Consistent Explorer";
        if (_score >= 500) return "Motivated Beginner";
        return "Novice";
    }
